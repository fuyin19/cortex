...
- Distribution `cortex-record-kb`, import `cortex`, version `8.1.0`; profiles Record 1, Tag 2, Layout 5, and exact Registry v1/v2 (`cortex-kb-registry/v2`). Python is exactly 3.11/UCD 14.0.0 for naming. Layout 3 and Layout 4 have no runtime fallback.
