...
WHEEL_NAME = "cortex_collaborative_workspace-1.1.2-py3-none-any.whl"
DIST_INFO = "cortex_collaborative_workspace-1.1.2.dist-info"
...
def _source(root: Path) -> list[tuple[str, bytes]]:
    ...
    for exact in (
        'name = "cortex-collaborative-workspace"', 'version = "1.1.2"', 'dependencies = []',
    ):
