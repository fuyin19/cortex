...
- Distribution `cortex-record-kb`, command/package `cortex`, version `6.0.0`; profile versions Record 1, Tag 2, Layout 3, Registry 1. Normal v6 operation rejects Layout 2 without fallback.
